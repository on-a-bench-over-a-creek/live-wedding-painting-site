...
function packagesPage() {
  const packages = [["The Classic", "Timeless and detailed piece in a classic style", "$1,800"], ["The Nostalgia Keepsake", "The signature experience: a generous canvas, your chosen scene, and the whole room invited in.", "$2,800"], ["The Memory Montage", "A larger-scale heirloom with extra details and time for the little moments.", "$3,800"]];
